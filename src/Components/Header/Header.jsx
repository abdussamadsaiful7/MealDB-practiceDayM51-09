...
const Header = () => {
    return (
        ...
        <div className='flex justify-between mx-8 no-underline mt-10 bg-slate-300 px-6 py-6
             text-black text-lg font-bold shadow-lg rounded-bl-md hover:bg-pink-400'>
